...
}:
{
  imports = [
    ...
    ./settings/nixos/hyprland/default.nix
    ./settings/nixos/localization/default.nix
    ./settings/nixos/sops/default.nix
    ./settings/nixos/stylix/default.nix
    ./settings/nixos/wayland/default.nix
